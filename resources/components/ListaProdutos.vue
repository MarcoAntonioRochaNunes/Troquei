<template>
    <section class="px-5 text-left ">
        <slot></slot>
        <div class="flex gap-5 items-center justify-center flex-wrap max-w-screen-xl">
            <div class="mt-10 w-[280px] h-[450px] border-neutral-300 border-double border-4 rounded-xl relative">
                <a href="#">
                    <div class=" max-h-[260px] max-w-[260px] w-full h-full rounded-lg m-auto mt-2 overflow-hidden relative">
                        ...
                        <div class="absolute h-[40px] w-[40px] rounded-full right-1 top-1 border-solid border-2 border-[#FF6E00] overflow-hidden">
