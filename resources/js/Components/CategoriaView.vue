<template>
  <section class="px-5 text-left mt-16">
    <slot></slot>
    <div class="mt-12 px-5 flex justify-center gap-3" >
        <button class="rounded-lg py-3 px-6 text-white bg-[#FF6E00] flex  text-center justify-center gap-1" v-for="categoria in categorias" :key="categoria.id">
